...
sheetKey = 'TARGET GOOGLE SHEET'  # Target sheet to write data
clientSecret = 'CLIENT SECRET PATH'  # Path to client secret JSON file from
serviceFile = 'SERVICE FILE PATH'  # Path to service JSON file
